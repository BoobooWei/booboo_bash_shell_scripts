...
- [shell 脚本](#shell-脚本)
	...
	- [if 语法格式](#if-语法格式)
	- [for 语法格式](#for-语法格式)
	- [while 语法格式](#while-语法格式)
	- [until 语法格式](#until-语法格式)
	- [case 语法格式](#case-语法格式)
	- [continue 语法格式](#continue-语法格式)
	- [break 语法格式](#break-语法格式)
	- [shift 语法格式](#shift-语法格式)
	- [function 语法格式](#function-语法格式)
...
默认为局部变量，因此不同的函数可以使用同一个变量；
如果要变成全局变量，需要使用golbal来修饰，那么不同的函数都能访问到这个全局变量。
